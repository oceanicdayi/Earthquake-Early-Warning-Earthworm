...
/* Pick weight calculation
   ***********************/
         ...
         {
             Pick->weight = 4;
             if ( (xp0 > 6.) && (xp1 > 6.) && fabs(xp0-xp1 )>2.0  )  {Pick->weight = 3;}
             if ( (xp0 > 6.) && (xp1 > 6.) && fabs(xp0-xp1 )>10.0  ) {Pick->weight = 2;}
             if ( (xp0 > 8.) && (xp1 > 8.) && fabs(xp0-xp1 )>2.0  )  {Pick->weight = 2;}
             if ( (xp0 > 5.) && (xp1 > 5.) && (xp0+xp1 > 300.) )   {Pick->weight = 1;}
             if ( (xp0 > 10.) && (xp1 > 10.) && (xp0+xp1 > 30.) )   {Pick->weight = 1;}
         }
